...
public class CommitteesResults
{
    ...
    {
        return "ClassPojo [subcommittee = "+subcommittee+", name = "+name+", committee_id = "+committee_id+", parent_committee_id = "+parent_committee_id+", chamber = "+chamber+"]";
    }
}
